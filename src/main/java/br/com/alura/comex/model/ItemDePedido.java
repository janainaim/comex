...
public class ItemDePedido {
    ...
    public ItemDePedido(BigDecimal precoUnitario, Long quantidade, Produto produto, Pedido pedido,
                        BigDecimal desconto, TipoDeDescontoPorItemDePedido tipoDeDescontoPorItemDePedido) {
